 ...
 * Tag
 *
 * @ORM\Table(name="fm_tag")
 * @ORM\HasLifecycleCallbacks
 * @ORM\Entity(repositoryClass="FaraData\FileManagerBundle\Repository\TagRepository")
 */
class Tag
{
    /**
     ...
     * Add medium
     *
     * @param \FaraData\FileManagerBundle\Entity\Media $medium
     *
     * @return Tag
     */
