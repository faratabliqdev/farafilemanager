...
namespace FaraData\FileManagerBundle\Helpers;
...
//                )
                                          ...
                                          $index, $content_range)
    {
        ...
        //todo add guessClientExtension() to check file extension
...
//        try {
        ...
        // add user prefered name to the media
        if ($this->options['prefered_media_name']) { $name = $this->options['prefered_media_name']; }
