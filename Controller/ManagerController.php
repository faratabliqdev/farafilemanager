...
use FaraData\FileManagerBundle\DependencyInjection\ResizeImage;
use FaraData\FileManagerBundle\Entity\Gallery;
use FaraData\FileManagerBundle\Entity\Tag;
use FaraData\FileManagerBundle\Event\FileManagerEvents;
use FaraData\FileManagerBundle\Form\MediaGallerySearchType;
use FaraData\FileManagerBundle\Form\MediaRemoteType;
use FaraData\FileManagerBundle\Helpers\File;
use FaraData\FileManagerBundle\Helpers\FileManager;
use FaraData\FileManagerBundle\Helpers\UploadHandler;
use FaraData\FileManagerBundle\Twig\OrderExtension;
use FaraData\FileManagerBundle\Entity\Media;
use FaraData\FileManagerBundle\Form\MediaSearchType;
use FaraData\FileManagerBundle\Form\MediaType;
use FaraData\FileManagerBundle\Repository\MediaRepository;
...
/**
 * @author Ali Kazemi <Developer@Azrael.ir> , <Kazemi@FaraData.co>
 */
class ManagerController extends Controller
{
    ...
    protected function initialise()
    {
        ...
        $this->mediaRepository = $this->getDoctrine()->getRepository('FaraDataFileManagerBundle:Media');
        $this->tagRepository = $this->getDoctrine()->getRepository('FaraDataFileManagerBundle:Tag');
        $this->galleryRepository = $this->getDoctrine()->getRepository('FaraDataFileManagerBundle:Gallery');
...
//            'fileArray' => $fileArray,
        ...
        if ($isJson) {
            $fileList = $this->renderView('@FaraDataFileManager/views/_manager_view.html.twig', $parameters);
        ...
        return $this->render('@FaraDataFileManager/manager.html.twig', $parameters);
    }
