...
use FaraData\FileManagerBundle\Form\TagType;
use FaraData\FileManagerBundle\Repository\TagRepository;
...
//        $event = $stopwatch->stop('ajax');
    ...
    {
        return $this->render('@FaraDataFileManager/tag/index.html.twig', ['tags' => $tagRepository->findAll()]);
    }
    ...
    public function newTag(Request $request)
    {
        ...
        return $this->render('@FaraDataFileManager/tag/new.html.twig', [
            'tag' => $tag,
    ...
    {
        return $this->render('@FaraDataFileManager/tag/show.html.twig', ['tag' => $tag]);
    }
    ...
    public function edit(Request $request, Tag $tag)
    {
        ...
        return $this->render('@FaraDataFileManager/tag/edit.html.twig', [
            'tag' => $tag,
            'form' => $form->createView(),
        ]);
    }
