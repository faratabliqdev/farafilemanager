...
use FaraData\FileManagerBundle\Form\MediaEditType;
...
//        $searches = '';
        ...
        return $this->render('@FaraDataFileManager/media/search.html.twig', [
            'searches' => $searches,
        ]);
    }
    ...
    {
        return $this->render('@FaraDataFileManager/media/index.html.twig', ['media' => $mediaRepository->findAll()]);
    }
...
//            $extentJson = $uploadedFile->getExtension();
        ...
        return $this->render('@FaraDataFileManager/media/new.html.twig', [
            'medium' => $medium,
    ...
    public function show(Request $request)
    {
        ...
        $medium = $this->getDoctrine()->getRepository('FaraDataFileManagerBundle:Media')->findOneBy(['id' => $mediaId]);
        return $this->render('@FaraDataFileManager/media/show.html.twig', ['medium' => $medium]);
    }
...
//              return $this->redirectToRoute('media_edit', ['id' => $medium->getId()]);
        ...
        return $this->render('@FaraDataFileManager/media/edit.html.twig', [
            'medium' => $medium,
            'form' => $form->createView(),
        ]);
    }
