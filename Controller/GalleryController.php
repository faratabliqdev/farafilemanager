...
use FaraData\FileManagerBundle\Datatables\GalleryDatatable;
use FaraData\FileManagerBundle\Entity\Gallery;
use FaraData\FileManagerBundle\Form\GalleryType;
use FaraData\FileManagerBundle\Repository\GalleryRepository;
...
class GalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->render('@FaraDataFileManager/gallery/index.html.twig', array(
            'datatable' => $datatable,
        ));
    }
    ...
    public function newGallery(Request $request)
    {
        ...
        return $this->render('@FaraDataFileManager/gallery/new.html.twig', [
            'gallery' => $gallery,
    ...
    {
        return $this->render('@FaraDataFileManager/gallery/show.html.twig', ['gallery' => $gallery]);
    }
    ...
    public function edit(Request $request, Gallery $gallery)
    {
        ...
        return $this->render('@FaraDataFileManager/gallery/edit.html.twig', [
            'gallery' => $gallery,
            'form' => $form->createView(),
        ]);
    }
